...
int main(){
	...
	transferData[0] = (PositionColorVertex) {-0.5,-0.5,0,0xFF,0x00,0x00,0xFF };
	transferData[1] = (PositionColorVertex) { 0.5,-0.5,0,0x00,0xFF,0x00,0xFF };
	transferData[2] = (PositionColorVertex) { 0  , 0.5,0,0x00,0x00,0xFF,0xFF };
